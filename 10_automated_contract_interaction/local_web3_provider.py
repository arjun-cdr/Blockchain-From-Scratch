...
class Web3_Provider:
    ...
    def __init__(self, node_url):
        ...
        if not self.is_connected():
            logger.warning(f"Warning !!! Unable to reach local node at {self.node_url} ")
    ...
    def _send_request(self, endpoint, method, payload = None):
    ...
    def get_chain(self):
        return self._send_request("/chain", method = "GET")
